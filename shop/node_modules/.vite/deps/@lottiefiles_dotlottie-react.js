...
var e3 = class L {
  ...
  static transformThemeToLottieSlots(i, n) {
    var _a;
    return ((_a = L._wasmModule) == null ? void 0 : _a.transformThemeToLottieSlots(i, n)) ?? "";
  }
...
var g2 = class s1 {
  constructor(i) {
    ...
    let d = { ...i, renderConfig: { ...i.renderConfig, devicePixelRatio: ((_a = i.renderConfig) == null ? void 0 : _a.devicePixelRatio) || d1(), freezeOnOffscreen: ((_b = i.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true } };
...
var K1 = ({ animationId: h, autoplay: i, backgroundColor: n, className: d, createDotLottie: _, data: g, dotLottieRefCallback: c, layout: W, loop: V, mode: J, playOnHover: m1, renderConfig: u1, segment: D, speed: l1, src: q, stateMachineConfig: i1, stateMachineId: K, style: _1, themeData: f1, themeId: B, useFrameInterpolation: E, workerId: n1, ...Z }) => {
  ...
  let k1 = (0, import_react.useCallback)((x) => {
    var _a, _b;
    C.current = x, x ? M.current = _({ ...r1.current, canvas: x }) : ((_a = M.current) == null ? void 0 : _a.destroy(), M.current = null), (_b = g1.current) == null ? void 0 : _b.call(g1, M.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let x = (w1) => {
      var _a2, _b2;
      m1 && (w1.type === "mouseenter" && ((_a2 = M.current) == null ? void 0 : _a2.play()), w1.type === "mouseleave" && ((_b2 = M.current) == null ? void 0 : _b2.pause()));
    };
    ...
    var _a;
    (_a = M.current) == null ? void 0 : _a.setSpeed(l1 ?? 1);
    ...
    var _a;
    (_a = M.current) == null ? void 0 : _a.setUseFrameInterpolation(E ?? true);
    ...
    var _a;
    typeof g != "string" && typeof g != "object" || ((_a = M.current) == null ? void 0 : _a.load({ data: g, ...r1.current }));
  }, [g]), (0, import_react.useEffect)(() => {
    var _a;
    typeof q == "string" && ((_a = M.current) == null ? void 0 : _a.load({ src: q, ...r1.current }));
    ...
    var _a;
    typeof B == "string" && ((_a = M.current) == null ? void 0 : _a.setTheme(B));
  }, [B]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = M.current) == null ? void 0 : _a.setThemeData(f1 ?? "");
